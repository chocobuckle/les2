...
function html5blank_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
        if ( HTML5_DEBUG ) {
            ...
            wp_register_script( 'jquery', get_template_directory_uri() . '/js/lib/jquery-3.0.0.min.js', array(), '3.0.0' );
            ...
            // CUSTOM
            // Animated.headline
            wp_register_script( 'animatedHeadline', get_template_directory_uri() . '/js/lib/animated.headline.js', array(), '1.0' );

            // App
            // wp_register_script( 'app', get_template_directory_uri() . '/js/lib/app.js', array(), '1.0' );

            // Isotope
            wp_register_script( 'isotope', get_template_directory_uri() . '/js/lib/isotope.pkgd.min.js', array(), '1.0' );
            
            // jqueryCounterup
            wp_register_script( 'jqueryCounterup', get_template_directory_uri() . '/js/lib/jquery.counterup.min.js', array(), '1.0' );
                       
            // jqueryMagnific-popup
            wp_register_script( 'jqueryMagnific-popup', get_template_directory_uri() . '/js/lib/jquery.magnific-popup.min.js', array(), '1.0' );

            // jqueryStellar
            wp_register_script( 'jqueryStellar', get_template_directory_uri() . '/js/lib/jquery.stellar.min.js', array(), '1.0' );
              
            // jqueryWaypoints
            wp_register_script( 'jqueryWaypoints', get_template_directory_uri() . '/js/lib/jquery.waypoints.min.js', array(), '1.0' );
                          
            // jqueryYoutubebackground
            wp_register_script( 'jqueryYoutubebackground', get_template_directory_uri() . '/js/lib/jquery.youtubebackground.js', array(), '1.0' );
                        
            // Map
            wp_register_script( 'map', get_template_directory_uri() . '/js/lib/maps.js', array(), '1.0' );
                                            
            // owlCarousel
            wp_register_script( 'owlCarousel', get_template_directory_uri() . '/js/lib/owl.carousel.min.js', array(), '1.0' );
                                                                         
            // particles
            wp_register_script( 'particles', get_template_directory_uri() . '/js/lib/particles.min.js', array(), '1.0');
                                                                                                     
            // popper
            wp_register_script( 'popper', get_template_directory_uri() . '/js/lib/popper.min.js', array(), '1.0' );
                            
            // scrollIt
            wp_register_script( 'scrollIt', get_template_directory_uri() . '/js/lib/scrollIt.min.js', array(), '1.0' );
                            
            // validator
            wp_register_script( 'validator', get_template_directory_uri() . '/js/lib/validator.js', array(), '1.0' );
                            
           //  YouTubePopUp.jquery
           wp_register_script( 'YouTubePopUp', get_template_directory_uri() . '/js/lib/YouTubePopUp.jquery.js', array(), '1.0' );
