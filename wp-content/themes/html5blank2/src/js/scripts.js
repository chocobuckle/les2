...
$(function() {
    ...
    $(".navbar-toggler .icon-bar").on("click", function () {
        $(".navbar-collapse").toggleClass("show");
    });

    $(".navbar").on("click",".show li a",function() {
        $(".navbar-collapse").toggleClass("show");   
    });
    ...
    $("#CurrentOpportunities .owl-carousel").owlCarousel({
        nav:true,
...
// HOVER ON TEAM 
    ...
    $( ".team-img" ).mouseleave(function() {
        $(this).children(".disabled").css({"opacity":"0"});
    });
