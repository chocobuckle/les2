<!-- =====================================
    	==== Start Blog -->
    	<section class="blog section-padding" id="CurrentOpportunities" data-scroll-index="3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="item text-center mb-md50">
                            <div class="post-img">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/blog/1.jpg" alt="">
                                <div class="date">
                                    <a href="#0">
                                        <span>06</span>
                                        <span>Aug</span>
                    ...
                    <div class="col-lg-4">
                        <div class="item text-center mb-md50">
                            <div class="post-img">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/blog/2.jpg" alt="">
                                <div class="date">
                                    <a href="#0">
                                        <span>06</span>
                                        <span>Aug</span>
                    ...
                    <div class="col-lg-4">
                        <div class="item text-center">
                            <div class="post-img">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/blog/3.jpg" alt="">
                                <div class="date">
                                    <a href="#0">
                                        <span>06</span>
                                        <span>Aug</span>
