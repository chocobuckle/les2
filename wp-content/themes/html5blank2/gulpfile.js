...
var gulp = require( "gulp" ),
	...
	uglifySrc = [
		...
		// Isotope
		'src/js/lib/isotope.pkgd.min.js', 

		// jqueryCounterup
		'src/js/lib/jquery.counterup.min.js', 
				
		// particles
		'src/js/lib/particles.min.js',

		// Animated.headline
		'src/js/lib/animated.headline.js', 

		// jqueryMagnific-popup
		'src/js/lib/jquery.magnific-popup.min.js', 

		// jqueryStellar
		'src/js/lib/jquery.stellar.min.js', 
		
		// jqueryWaypoints
		'src/js/lib/jquery.waypoints.min.js', 
					
		// jqueryYoutubebackground
		'src/js/lib/jquery.youtubebackground.js',
		...
		// scrollIt
		'src/js/lib/scrollIt.min.js', 
						
		// validator
		'src/js/lib/validator.js', 
						
		//  YouTubePopUp.jquery
		'src/js/lib/YouTubePopUp.jquery.js', 
